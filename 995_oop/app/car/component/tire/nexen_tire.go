...
func (v *nexenTire) MoveForward() {
	...
	case code.Straight:
		...
		fmt.Printf("Straight, Current Position - x :%v, y :%v", v.maps.CurrentX, v.maps.CurrentY)
	case code.RightDiagonal:
		fmt.Printf("After RightDiagonal, Current Position - x :%v, y :%v", v.maps.CurrentX, v.maps.CurrentY)
	case code.LeftDiagonal:
		fmt.Printf("After LeftDiagonal, Current Position - x :%v, y :%v", v.maps.CurrentX, v.maps.CurrentY)
	}
}
